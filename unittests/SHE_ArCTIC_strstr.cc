#define BOOST_TEST_MODULE SHE_ArCTIC_Strstr_Test

#include <boost/test/unit_test.hpp>

#include "SHE_ArCTIC/strstr.hh"


BOOST_AUTO_TEST_SUITE( SHE_ArCTIC_strstr )

BOOST_AUTO_TEST_CASE( strstr_strtok_test1 )
{
