/* (C) Copyright 2013 by Oliver Cordes         
    ...
    This file is part of arctuc-project.
...
/* cte_image_euclid.hh
   ...
   $Id: cte_image_euclid.hh 914 2015-11-30 15:30:27Z ocordes $

*/

#ifndef __cte_image_euclid_h

#define __cte_image_euclid_h 1
...
class cte_image_euclid {
public:
  cte_image_euclid( std::shared_ptr<params> p);
